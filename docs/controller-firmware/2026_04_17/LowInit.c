...
PORTB=(1<<PORTB7) | (0<<PORTB6) | (1<<PORTB5) | (1<<PORTB4) | (1<<PORTB3) | (1<<PORTB2) | (1<<PORTB1) | (1<<PORTB0);
...
DDRG=(0<<DDG5) | (0<<DDG4) | (0<<DDG3) | (0<<DDG2) | (1<<DDG1) | (1<<DDG0);
// State: Bit5=T Bit4=T Bit3=T Bit2=T Bit1=1 Bit0=1 
PORTG=(0<<PORTG5) | (0<<PORTG4) | (0<<PORTG3) | (0<<PORTG2) | (1<<PORTG1) | (1<<PORTG0);

// Port H initialization
// Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=Out Bit2=Out Bit1=Out Bit0=Out 
DDRH=(0<<DDH7) | (0<<DDH6) | (0<<DDH5) | (0<<DDH4) | (1<<DDH3) | (1<<DDH2) | (1<<DDH1) | (1<<DDH0);
...
DDRJ=(0<<DDJ7) | (0<<DDJ6) | (1<<DDJ5) | (1<<DDJ4) | (1<<DDJ3) | (1<<DDJ2) | (0<<DDJ1) | (0<<DDJ0);
...
// Noise Canceler: Off
// Input Capture on Falling Edge
// Timer Period: 1,1111 ms
// Output Pulse(s):
// OC3A Period: 1,1111 ms Width: 0 us
// OC3B Period: 1,1111 ms Width: 0 us
// OC3C Period: 1,1111 ms Width: 0 us
...
EIFR=(0<<INTF7) | (0<<INTF6) | (0<<INTF5) | (0<<INTF4) | (0<<INTF3) | (0<<INTF2) | (1<<INTF1) | (0<<INTF0);
...
UCSR3B=(1<<RXCIE3) | (1<<TXCIE3) | (0<<UDRIE3) | (1<<RXEN3) | (1<<TXEN3) | (0<<UCSZ32) | (0<<RXB83) | (0<<TXB83);
...
DIDR0=(0<<ADC7D) | (0<<ADC6D) | (0<<ADC5D) | (0<<ADC4D) | (0<<ADC3D) | (0<<ADC2D) | (1<<ADC1D) | (1<<ADC0D);
