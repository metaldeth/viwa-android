...
void Mors_Syrup_Routine1(void)
{
                        ...
                        //------- Receipt calculation ----------- 
                         ...
                         if((Type_of_water==0)||(Type_of_water==1))  // filtered/ cold water
                           {
                          ...
                          //--------------------
                           if(Type_of_water==3)  // soda cold water
                             {
                              // koeff_time - calculated koefficient for max time prepareing  in msec
                              time_water_fill=(unsigned int)(data_water_temp*swkoeff_time);    // Maximal time water filling in msec
